...
<div>
    <section class="section">
        <div class="section-header">
            <h1>Pengelolaan Jurusan</h1>
            <div class="section-header-breadcrumb">
                <button class="btn btn-primary" data-toggle="modal" data-target="#tambahJurusan">Jurusan baru</button>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Jurusan Baru</h5>
